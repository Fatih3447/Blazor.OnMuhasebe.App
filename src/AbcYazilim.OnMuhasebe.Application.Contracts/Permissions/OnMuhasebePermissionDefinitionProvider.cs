    ...
    public class OnMuhasebePermissionDefinitionProvider : PermissionDefinitionProvider
    {
        public override void Define(IPermissionDefinitionContext context)
        {
            ...
            banka.AddChild(OnMuhasebePermissions.Banka_.Create,
                L($"{localizePrefix}:{nameof(OnMuhasebePermissions.Banka_)}{OnMuhasebePermissions.CreateConst}"));//Permission:Banka.Create
            banka.AddChild(OnMuhasebePermissions.Banka_.Update,
                L($"{localizePrefix}:{nameof(OnMuhasebePermissions.Banka_)}{OnMuhasebePermissions.UpdateConst}"));//Permission:Banka.Update
