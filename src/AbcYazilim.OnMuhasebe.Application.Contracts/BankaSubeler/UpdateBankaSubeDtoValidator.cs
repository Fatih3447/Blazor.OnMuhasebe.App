...
public class UpdateBankaSubeDtoValidator:AbstractValidator<UpdateBankaSubeDto>
{
    public UpdateBankaSubeDtoValidator(IStringLocalizer<OnMuhasebeResource> localizer)
    {
        RuleFor(x => x.Kod)
           .NotEmpty()
